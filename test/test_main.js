...
describe('Elastic Search', function () {
  describe('Test the package with elasticsearch bulk processing', function () {
    ...
    it('run', function (done) {
      ...
      nock('https://landsat.usgs.gov')
        .get('/landsat/metadata_service/bulk_metadata_files/LANDSAT_8_C1.csv')
        .reply(200, csv);
  ...
  describe('Test the package with elasticsearch single processing', function () {
    this.timeout(1000000);
    var testIndex = 'test_main';
    var testType = '8';
    var downloadDir = __dirname + '/download';
...
describe('MongoDB', function () {
  describe('Test the package with mongoDB bulk process', function () {
    this.timeout(1000000);
    var testIndex = 'test_main';
    var testType = '8';
    var downloadDir = __dirname + '/download';
    ...
    it('check country name for a record', function (done) {
      Landsat.find({sceneID: 'LC81630232015162LGN00'}, function (err, record) {
        expect(err).to.be.null;
        expect(record[0].countries[0].name).to.equal('Kazakhstan');
        done();
      });
    });
  ...
  describe('Test the package with mongoDB single process', function () {
    this.timeout(1000000);
    var testIndex = 'test_main';
    var testType = '8';
    var downloadDir = __dirname + '/download';
